...
T6D_LOWER_BODY_JOINTS = [0,9,16,12,14,20,25,29,3,1,23,7, 30]

mask_lst = []

for i in range(31):
    if i in T6D_LOWER_BODY_JOINTS:
        mask_lst.append(True)
    else:
        mask_lst.append(False)

T6D_LOWER_BODY_MSAK = np.array(mask_lst)