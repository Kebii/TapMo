...
def add_base_options(parser):
    ...
    group.add_argument("--seed", default=186, type=int, help="For fixing random seed.")
...
def add_model_options(parser):
    ...
    group.add_argument("--lambda_mesh", default=0.0, type=float, help="Mesh L2 loss.")
    group.add_argument("--lambda_arap", default=0.0, type=float, help="Mesh smooth loss.")
    group.add_argument("--lambda_handle", default=0.0, type=float, help="Handel loss.")
    group.add_argument("--lambda_gen", default=0.1, type=float, help="GEN loss.")
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='trans', choices=['t6d_mixrig'], type=str,
...
def add_training_options(parser):
    ...
    group.add_argument("--num_steps", default=900_000, type=int,
