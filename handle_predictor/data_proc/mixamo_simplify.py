...
obj_dir = "/apdcephfs/private_jiaxuzhang_cq/datasets/skeleton_free/evaluate/eval_rabit_mesh"
# obj_remesh_dir = MIXAMO_SIMPLIFY_PATH + '/obj_remesh'
obj_remesh_dir = "/apdcephfs/private_jiaxuzhang_cq/datasets/skeleton_free/evaluate/eval_rabit_remesh"
