...
class AmassDataset(Dataset):
    def __init__(self, data_path, smpl, flag='train', part_augmentation=False, part_aug_scale=1,
                 simplify=True, joint_augmentation=False):
...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        plt.savefig('/apdcephfs/private_jiaxuzhang_cq/code/work_dir/smpl.jpg')

        print(data.triangle.shape)
        print(data.v0.shape)

        save_obj('/apdcephfs/private_jiaxuzhang_cq/code/work_dir/smpl.obj', data.aug_v0.numpy(), data.triangle[0])
