...
class RignetDataset(Dataset):
    ...
    def get(self, index):
        ...
        return Data(v0=v0, v1=v1, tpl_edge_index=tpl_edge_index, triangle=f[None].astype(int), name=name,
                    ...
                    feat0=normal_v0, feat1=normal_v1,
...
if __name__ == '__main__':
    ...
    dataset = RignetDataset("./datasets/skeleton_free/RigNet", flag='humanoid_test_new')
    data1,data2 = dataset.get(5)
    ...
    sequence_containing_x_vals = data1.joints[0][:,0]
    sequence_containing_y_vals = data1.joints[0][:,1]
    sequence_containing_z_vals = data1.joints[0][:,2]

    ax.scatter(sequence_containing_x_vals, sequence_containing_y_vals, sequence_containing_z_vals, s=3)

    plt.savefig('./code/work_dir/rignet.jpg')

    save_obj('./code/work_dir/rignet.obj', data1.aug_v1.numpy(), data1.triangle[0])
